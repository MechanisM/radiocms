...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Episode.description'
        db.add_column('programmes_episode', 'description', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Episode.description'
        db.delete_column('programmes_episode', 'description')
