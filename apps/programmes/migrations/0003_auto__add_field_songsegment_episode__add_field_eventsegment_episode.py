...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SongSegment.episode'
        db.add_column('programmes_songsegment', 'episode', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['programmes.Episode']), keep_default=False)

        # Adding field 'EventSegment.episode'
        db.add_column('programmes_eventsegment', 'episode', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['programmes.Episode']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SongSegment.episode'
        db.delete_column('programmes_songsegment', 'episode_id')

        # Deleting field 'EventSegment.episode'
        db.delete_column('programmes_eventsegment', 'episode_id')
